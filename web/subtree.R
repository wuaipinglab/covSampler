...
parser$add_argument("--tree", required=TRUE, help="Tree file directory")
parser$add_argument("--lineage", required=TRUE, help="Lineage file path")
parser$add_argument("--version", required=TRUE, help="Version")
parser$add_argument("--output", required=TRUE, help="Output directory path")
args <- parser$parse_args()

# tree <- read.tree(args$tree)
tree <- read.tree(paste(args$tree, args$version, 'rawdata', 'timetree.nwk', sep='/'))
